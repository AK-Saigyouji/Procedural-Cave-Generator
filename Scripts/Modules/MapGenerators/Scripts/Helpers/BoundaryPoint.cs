...
namespace CaveGeneration.Modules
{
    ...
    public sealed class BoundaryPoint
    {
        ...
        public Side BoundarySide
        {
            get { return side; }
            set
            {
                if (!IsValidSide(value)) throw new System.ComponentModel.InvalidEnumArgumentException();
                side = value;
            }
        }
        ...
        /// </summary>
        public int Magnitude { get { return magnitude; } set { magnitude = value; } }

        public BoundaryPoint(Side side, int magnitude)
        {
            if (!IsValidSide(side)) throw new System.ComponentModel.InvalidEnumArgumentException();
            this.side = side;
